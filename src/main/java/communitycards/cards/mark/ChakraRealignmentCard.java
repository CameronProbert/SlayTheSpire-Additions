...
import communitycards.actions.mark.ChakraRealignmentAction;
import communitycards.cards.BaseCard;
import communitycards.util.CardStats;

public class ChakraRealignmentCard extends BaseCard {
    public static final String ID = makeID("ChakraRealignmentCard");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ChakraRealignmentAction(m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
}
