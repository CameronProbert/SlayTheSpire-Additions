...
import communitycards.CommunityCards;
import communitycards.util.CardStats;
import communitycards.util.TriFunction;
...
import static communitycards.util.GeneralUtils.removePrefix;
import static communitycards.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return CommunityCards.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    CommunityCards.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
