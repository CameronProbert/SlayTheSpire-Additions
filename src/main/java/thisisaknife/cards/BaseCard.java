...
import thisisaknife.ThisIsAKnife;
import thisisaknife.util.CardStats;
import thisisaknife.util.TriFunction;
...
import static thisisaknife.util.GeneralUtils.removePrefix;
import static thisisaknife.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ThisIsAKnife.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ThisIsAKnife.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
